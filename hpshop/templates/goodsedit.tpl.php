	...
	<div id="div_setting_2" class="contentList">
		...
		d.uploadfile();return false;}, function(){window.top.art.dialog({id:'crop'}).close()});
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="point_mode"  <?php if ($info['point_mode']=='0') {?>checked <?php }?> id="fhmet1" value="0"><label for="fhmet1">固定积分（元）</label>
                        <input type="radio" name="point_mode"  <?php if ($info['point_mode']=='1') {?>checked <?php }?> id="fhmet2" value="1"><label for="fhmet2">商品百分比（%）</label>
                    </td>
                </tr>
                <tr>
