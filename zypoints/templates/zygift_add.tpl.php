...
<form name="myform" id="myform" action="?m=zypoints&c=zypoints&a=add" method="post">
                ...
                <fieldset>
                    ...
                    <table width="100%" class="table_form">
                        ...
                        <tr>
                            ...
                            <td><input type="text" required name="giftname" class="input-text" id="giftname" size="15" ></td>
                        </tr>
                        <tr>
                            <th width="120">详细描述</th>
                            <td><input type="text" name="giftdes" class="input-text" id="giftdes" size="15" ></td>
                        </tr>
                        <tr>
                            <th>缩略图</th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" required name="giftpoint" class="input-text" id="giftpoint" size="15" onkeyup="value=value.replace(/[^\d]/g,'')"></td>
                        </tr>
                        <tr>
                            <th width="120">礼物数量</th>
                            <td><input type="text" required name="giftnum" class="input-text" id="giftnum" size="15"  onkeyup="value=value.replace(/[^\d]/g,'')"></td>
                        </tr>
                        <tr>
