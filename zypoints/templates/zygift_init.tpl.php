...
<div class="subnav">
    <div class="content-menu ib-a blue line-x">
        <a class="add fb" href="javascript:window.top.art.dialog({id:'add',iframe:'?m=zypoints&c=zypoints&a=add',title:'添加礼物', width:'800', height:'600', lock:true}, function(){var d = window.top.art.dialog({id:'add'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;},function(){window.top.art.dialog({id:'add'}).close()});void(0);">
            <em>添加礼物</em></a>
    </div>
</div>
...
<?php echo '礼物名称'?>  <input type="text" value="<?php echo $_GET['giftname']?>" class="input-text" name="giftname">
...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
            ...
            <th align="center"><strong>详细描述</strong></th>
            <th align="center"><strong>缩略图</strong></th>
            <th align="center"><strong>所需积分</strong></th>
            <th align="center"><strong>剩余数量</strong></th>
	...
	<tbody>
			...
			<td align="center"><?php echo $row["giftdes"];?></td>
			<td align="center"><img src="<?php echo $row["thumb"];?>" height="100" width="100"></td>
            <td align="center"><?php echo $row["giftpoint"];?></td>
            <td align="center"><?php echo $row["giftnum"];?></td>
            <td align="center">
                <?php if($row["status"]==0){?>
                    <span style="color: red "><?php echo '关闭';?></span>
                <?php }else if($row["status"]==1){?>
                    <span style="color: green"><?php echo '显示';?></span>
                <?php } ?>
            </td>
            <td align="center">
                <a href="javascript:void(0);" class="btn btn-info btn-sm" onclick="edit('<?php echo $row['id']?>')"><?php echo L('编辑')?></a>
                <a href="javascript:confirmurl('?m=zypoints&c=zypoints&a=del&id=<?php echo $row['id']?>', '<?php echo L('确定删除此物品吗')?>')" class="btn btn-danger btn-sm"><?php echo L('删除')?></a>
            </td>
			</tr>
			<?php }?>
	</tbody>
